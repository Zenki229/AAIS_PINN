...
data1 = np.load('./results/KdV2D/KdV2D_Uni_resample_500e/train/loss_err.npy')
data2 = np.load('./results/KdV2D/KdV2D_RAD_resample_500e/train/loss_err.npy')
data3 = np.load('./results/KdV2D/KdV2D_AAIS_g_resample_500e/train/loss_err.npy')
data4 = np.load('./results/KdV2D/KdV2D_AAIS_t_resample_500e/train/loss_err.npy')
...
fig.savefig('./results/KdV2D/resample_500e_loss.png',dpi=300)
plt.show()
fig, ax = plt.subplots(layout='constrained', figsize=(19.2, 4.8))
...
ax.legend(loc='upper right')
fig.savefig('./results/KdV2D/resample_500e_err.png',dpi=300)
plt.show()

...
# # Poisson2D9Peak 5000e
# data1 = np.load('./results/Poisson5DPeaks/Poisson5DPeaks_RAD_resample_100k/train/loss_err.npy')
# data2 = np.load('./results/Poisson5DPeaks/Poisson5DPeaks_RAD_resample_200k/train/loss_err.npy')
# data3 = np.load('./results/Poisson5DPeaks/Poisson5DPeaks_AAIS_t_resample_100k/train/loss_err.npy')
# data4 = np.load('./results/Poisson5DPeaks/Poisson5DPeaks_AAIS_t_resample_200k/train/loss_err.npy')
# fig, ax = plt.subplots(layout='constrained', figsize=(6.4, 4.8))
# ax.semilogy(np.array(data1[:, 0]), label='RAD-100k')
# ax.semilogy(np.array(data2[:, 0]), label='RAD-200k')
# ax.semilogy(np.array(data3[:, 0]), label='AAIS-t-100k')
# ax.semilogy(np.array(data4[:, 0]), label='AAIS-t-200k')
# ax.set_ylim(1e-5, 3e3)
# ax.set_xlim(0, 110000)
# ax.set_xticks(ticks=[0,25000,50000,75000,100000], labels=['0', '25k', '50k', '75k', '100k'])
# ax.legend(loc='upper right')
# ax.set_xlabel('$Epochs$')
# ax.set_ylabel('Loss')
# fig.savefig('./results/Poisson5DPeaks/resample_loss.png',dpi=300)
# fig, ax = plt.subplots(layout='constrained', figsize=(6.4, 4.8))
# ax.semilogy(np.array(data1[:, 1]), label='RAD-100k')
# ax.semilogy(np.array(data2[:, 1]), label='RAD-200k')
# ax.semilogy(np.array(data3[:, 1]), label='AAIS-t-100k')
# ax.semilogy(np.array(data4[:, 1]), label='AAIS-t-200k')
# ax.set_xlim(0, 110000)
# ax.set_xticks(ticks=[0,25000,50000,75000,100000], labels=['0', '25k', '50k', '75k', '100k'])
# ax.set_ylim(8e-4, 1e1)
# ax.set_yticks(ticks=[1e-3,3e-3,1e-2,1e-1,1,10],labels=['$10^{-3}$','$3\\times 10^{-3}$','$10^{-2}$','$10^{-1}$', '$10^{0}$','$10^1$'])
# ax.legend(loc='upper right')
# ax.set_xlabel('$Epochs$')
# ax.set_ylabel('relative $L^2$ error $e_r(u(\\cdot;\\theta))$')
# fig.savefig('./results/Poisson5DPeaks/resample_err.png', dpi=300)

# # Poisson9D
# data2 = np.load('./results/Poisson9DPeaks/Poisson9DPeaks_RAD_resample_200k/train/loss_err.npy')
# data4 = np.load('./results/Poisson9DPeaks/Poisson9DPeaks_AAIS_t_resample_200k/train/loss_err.npy')
# fig, ax = plt.subplots(layout='constrained', figsize=(6.4, 4.8))
# ax.semilogy(np.array(data2[:, 0]), label='RAD-200k')
# ax.semilogy(np.array(data4[:, 0]), label='AAIS-t-200k')
# ax.set_ylim(1e-7, 8e4)
# ax.set_xlim(0, 220000)
# ax.set_xticks(ticks=[0,50000,100000,150000,200000], labels=['0', '50k', '100k', '150k', '200k'])
# ax.legend(loc='upper right')
# ax.set_xlabel('$Epochs$')
# ax.set_ylabel('Loss')
# fig.savefig('./results/Poisson9DPeaks/resample_loss.png',dpi=300)
# fig, ax = plt.subplots(layout='constrained', figsize=(6.4, 4.8))
# ax.semilogy(np.array(data2[:, 1]), label='RAD-200k')
# ax.semilogy(np.array(data4[:, 1]), label='AAIS-t-200k')
# ax.set_xlim(0, 220000)
...
# ax.set_xlabel('$Epochs$')
# ax.set_ylabel('relative $L^2$ error $e_r(u(\\cdot;\\theta))$')
# fig.savefig('./results/Poisson9DPeaks/resample_err.png', dpi=300)


# Poisson15D
data2 = np.load('./results/PoissonNDPeaks/PoissonNDPeaks_RAD_resample_100k/train/loss_err.npy')
data4 = np.load('./results/PoissonNDPeaks/PoissonNDPeaks_AAIS_t_resample_100k/train/loss_err.npy')
fig, ax = plt.subplots(layout='constrained', figsize=(6.4, 4.8))
ax.semilogy(np.array(data2[:, 0]), label='RAD-100k')
ax.semilogy(np.array(data4[:, 0]), label='AAIS-t-100k')
ax.set_ylim(1e-9, 1e1)
ax.set_xlim(-1000, 48000)
ax.set_xticks(ticks=[0,10000,20000,30000,40000], labels=['0', '10k', '20k', '30k', '40k'])
ax.legend(loc='upper right')
ax.set_xlabel('$Epochs$')
ax.set_ylabel('Loss')
fig.savefig('./results/PoissonNDPeaks/resample_loss.png',dpi=300)
fig, ax = plt.subplots(layout='constrained', figsize=(6.4, 4.8))
ax.semilogy(np.array(data2[:, 1]), label='RAD-100k')
ax.semilogy(np.array(data4[:, 1]), label='AAIS-t-100k')
ax.set_xlim(-1000, 48000)
ax.set_xticks(ticks=[0,10000,20000,30000,40000], labels=['0', '10k', '20k', '30k', '40k'])
ax.set_ylim(8e-3, 1e1)
ax.legend(loc='upper right')
ax.set_xlabel('$Epochs$')
ax.set_ylabel('relative $L^2$ error $e_r(u(\\cdot;\\theta))$')
fig.savefig('./results/PoissonNDPeaks/resample_err.png', dpi=300)

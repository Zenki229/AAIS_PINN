...
data3 = np.load('./results/Poisson2D1Peak/Poisson2D1Peak_AAIS_g_resample_2000e/train/ess_shape.npy')
data4 = np.load('./results/Poisson2D1Peak/Poisson2D1Peak_AAIS_t_resample_2000e/train/ess_shape.npy')
...
fig.savefig('./results/Poisson2D1Peak/resample_2000e_ess.png', dpi=300)
plt.show()
